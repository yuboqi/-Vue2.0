          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.baseSaleAttrId">
                ...
                <dd changepirce="0"  v-for="(item,index) in spuSaleAttr.spuSaleAttrValueList" :key="item.id" :class="{active:item.isChecked=='1'}" @click="changeIsChecked(item,spuSaleAttr.spuSaleAttrValueList)">{{item.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
<script>
  ...
  export default {
    ...
    methods: {
      changeIsChecked(item,arr,skuInfo){
        arr.forEach(item=>{
          item.isChecked = 0;
        })
        item.isChecked = 1;
