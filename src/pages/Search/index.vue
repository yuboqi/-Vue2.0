        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active: isOne}"  @click="changeNumOne('1')">
                  <a>综合<span v-show="isOne" v-if="isDown">↓</span> <span v-show="isOne" v-if="isUp">↑</span> </a>
                </li>

                <li :class="{active: isTwo}"  @click="changeNumTwo('2')">
                  <a>价格<span v-show="isTwo" v-if="isDown">↓</span> <span v-show="isTwo" v-if="isUp">↑</span></a>
                </li>
...
import Pagination from '../../components/Pagination/index.vue'
  export default {
    ...
    beforeMount(){
      ...
      //Object.assign写法(es6新增语法) 里面参数(A,a,b) 把a 和b的属性和值复制到A中
      Object.assign(this.searchParams,this.$route.query,this.$route.params)
    },
    mounted(){
      this.getData();
      //全局之间总线
      // this.$bus.$on('nihao',(trademark)=>{
